declare module 'piexifjs' {
  export const ImageIFD: {
    ...
    AsShotPreConverterStorage: number;
    AsShotWhitePoints: number;
    BaselineExposureOffset: number;
    DefaultBlackRender: number;
    BaselineExposureOffsetNumerator: number;
    BaselineExposureOffsetDenominator: number;
  ...
  export function dump(exifDict: Record<string, any>): string;
  export function load(jpegData: string): Record<string, any>;
